...
d3.csv("data/Queesland_color.csv", function(data) {
    ...
    svg.selectAll("path")
		...
		var marks = [{"name": "ESK HOSPITAL", "lat": -27.23946, "long": 152.4183 },
					 { "name": "GATTON HOSPITAL",   "lat": -27.566814,  "long": 152.276098 },
					 { "name": "LAIDLEY HOSPITAL",  "lat": -27.632641, "long": 152.400065 },
					 {  "name": "IPSWICH HOSPITAL", "lat": -27.619517,  "long": 152.757658 }, 
					 { "name": "BOONAH HOSPITAL", "lat": -27.998451,  "long": 152.678127 }]
			...
			//Angry
			var Angry = [ { "name": 1, "lat":-27.897760, "long": 152.153408 }]
			svg.selectAll(".angry")
			.data(Angry)
			.enter()
			.append("image")
