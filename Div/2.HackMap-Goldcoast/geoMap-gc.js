...
// Load Data
d3.csv("data/Queesland_color.csv", function(data) {
	color.domain([
    ...
    // Load GeoJSON Data
    d3.json("data/Queesland.json", function(json) {
    ...
    svg.selectAll("path")
		...
		//Marks
		var marks = [ { "name": "GOLD COAST HOSPITAL",  "lat": -27.970344, "long": 153.408973 },
					  { "name": "GOLD COAST HOSPITAL BIRTHING CENTRE", "lat": -27.970344,  "long": 153.408973},
					  { "name": "ROBINA HOSPITAL", "lat": -28.071046, "long": 153.375704}]
			...
			//Smile
			var Smiles = [ { "name": 1, "lat": -27.959318, "long": 153.286366 },
					  {"name": 1, "lat": -28.035407,  "long": 153.323101}]
			...
			//Angry
			var Angry = [ { "name": 1, "lat": -27.977512, "long": 153.427471 },
					  {"name": 1, "lat": -28.063889,  "long":153.366360}]
			svg.selectAll(".angry")
			.data(Angry)
			.enter()
			.append("image")
